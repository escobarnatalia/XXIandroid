...
/*
 * This class shows the jeans product available on the data base of the Android nodo.
 */
public class Jean extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        db.getReference().child("products").child("pants").addListenerForSingleValueEvent(
    ...
    protected void onResume() {
        super.onResume();
        db.getReference().child("Current").child("branch").setValue("pants");
